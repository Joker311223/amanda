    ...
    assignments: [
      // 正念作业
      {
        ...
        problems: [
          ...
          { type: "text", info: "3. 您使用的过程：" },
          { type: "text", info: "4. 使用技能的经验：" },
          {
            type: "multiple",
      ...
      },
      {
        ...
        problems: [
          ...
          {
            type: "text",
            info: "请描述这个技能是否让您的头脑变得更清晰。________",
          },
          { type: "text", info: "请描述练习的情景及练习方法。________" },
          {
            type: "text",
      ...
      // 痛苦耐受作业
      {
        ...
        problems: [
          { type: "score", info: "1. 危机事件痛苦程度（0-100分）：", range: [0, 100] },
          {
            type: "text",
          ...
          { type: "text", info: "4. 所使用技能的详细描述：" },
          { type: "text", info: "5. 使用技能的结果：" },
          {
            type: "choose",
      ...
      },
      {
        ...
        problems: [
          {
            type: "text",
            info: "T(改变温度)用冷水改变脸部的温度在(Temperature)\n情境:________\n情绪激发的程度(0~100):________\n痛苦承受程度(0=完全无法忍受100=肯定可以承受)\n使用前：________\n使用后:________\n您做了什么?________",
          },
          {
            type: "text",
            info: "I激烈运动(Intense Exercise)\n情境:________\n情绪激发的程度(0~100):________\n痛苦承受程度(0=完全无法忍受100=肯定可以承受)\n使用前:________\n使用后:________\n您做了什么?________",
          },
          {
            type: "text",
            info: "P调节呼吸(Paced breathing)\n情境:________\n情绪激发的程度(0~100):________\n痛苦承受程度(0=完全无法忍受100=肯定可以承受)\n使用前:________\n使用后:________\n您做了什么?________",
          },
          {
            type: "text",
            info: "P配对式肌肉放松(Pairedmusce reaxation)\n情境:________\n情绪激发的程度(0~100):________\n痛苦承受程度(0=完全无法忍受100=肯定可以承受)\n使用前:________\n使用后:________\n您做了什么?________",
          },
        ],
      },
      {
        ...
        problems: [
          {
            type: "text",
            info: "1.1我需要接纳的是:________\n接纳的评分(0~5):________",
          },
          {
            type: "text",
            info: "1.2我需要接纳的是：________\n接纳的评分(0~5):________",
          },
          {
            type: "text",
            info: "2.1我需要接纳的是:________\n接纳的评分(0~5):________",
          },
          {
            type: "text",
            info: "2.2 我需要接纳的是:________\n接纳的评分(0~5):________",
          },
          {
            type: "text",
            info: "3、重新检视你的列表回顾以上内容，并确认其真实性，确认您是否真的需要接纳这些事情。避免使用“好”坏”或任何评判性语言。若有必要，试着不加评判地描述上述内容。________",
          },
          {
            type: "multiple",
          ...
          {
            type: "score",
            info: "6、练习全然接纳后，对您所接纳的程度评分(0~5):________",
          },
        ],
      },
      {
        ...
        problems: [
          {
            type: "score",
            info: "危机事件1:痛苦程度(0~100)\n练习前:________\n练习后:________",
            range: [0, 100],
          },
          {
            type: "text",
            info: "2、诱发事件(人、事、时、地):危机是如何导致的?________",
          },
          {
            type: "multiple",
            info: "3、请勾选您尝试的技能。",
      ...
      },
      {
        ...
        problems: [
          ...
          {
            type: "text",
            info: "3、诱发事件(人、事、时、地):是什么引发了情绪?________",
          },
          ...
          {
            type: "text",
            info: "4.1行为冲动-我想做什么或说什么?若不合理，请填写:________",
          },
          {
            type: "text",
            info: "4.2相反行为-我的冲动的相反行为是什么?因为处于这种情绪中，我不会去做什么?同时描述此情境下您可能会做什么及如何采取完全相反的行为。若不合理，请填写:________",
          },
          {
            type: "text",
            info: "4.3我做了什么?具体描述，若不合理，请填写:________",
          },
          {
            type: "text",
            info: "4.4我如何做:描述肢体语言、面部表情姿势、手势和想法。若不合理，请填写:________",
          },
          {
            type: "text",
            info: "4.5相反行为会导致什么后果(心理状态其他情绪、行为、想法、记忆、身体状态等)?若不合理，请填写:________",
          },
        ],
      },
      {
