    ...
    assignments: [
      ...
      },
      {
        ...
        problems: [
          ...
          },
          {
            ...
            info: "请具体描述你尝试的技能：",
            placeholder:
              "请在此输入内容，比如“放松活动：和妈妈吵架后，回到房间做了10次深呼吸，跟着音乐拉伸肩膀；鼓励：对着镜子告诉自己‘妈妈是为我好，我可以好好和她沟通，不用生气’”",
          },
          {
            type: "text",
            info: "请描述使用技能的结果：",
            placeholder:
              "请在此输入内容，比如“放松后情绪平静了，后来和妈妈好好聊了聊，妈妈也理解了我的想法，我们和好了”",
          },
          {
            type: "choose",
      ...
      },
      {
        ...
        problems: [
          ...
          {
            type: "text",
            info: "5. 不重要且需接纳的事\n我需要接纳的是（提示：请具体描述第一件事，比如“我的个子比同班同学矮”）",
            placeholder: "请在此输入内容",
          },
          {
            type: "score",
      ...
      },
      {
        ...
        problems: [
          ...
          {
            type: "text",
            info: "2. 在此情境下评定你的优先顺序：1(最重要)，2(次重要)，3(最不重要）\n目标：",
            placeholder: "请在此输入内容",
          },
          {
            type: "score",
      ...
      },
      {
        ...
        problems: [
          ...
          },
          {
            ...
            info: "2、描述：",
            placeholder:
              "请在此输入内容，比如“我想让同学把借我的漫画书还给我，勾选了‘描述情境’‘表达感受/意见’‘明确态度’和‘协商妥协’，具体做了：找到同学后，我看着他的眼睛说‘上周你借了我的《XX漫画》，我现在有点着急，因为我还想再看一遍，希望你能这周还给我；如果你还没看完，我们也可以约定周末之前还我’",
          },
          {
            type: "text",
            info: "3、这次互动的效果如何？",
            placeholder:
              "请在此输入内容，比如“同学听后说他已经看完了，当天就把漫画书还给了我，我的目标达成了，而且我们沟通得很愉快，没有产生矛盾，我对这次互动很满意”",
          },
        ],
      },
    ],
