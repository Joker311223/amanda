    ...
    assignments: [
      ...
      },
      {
        ...
        problems: [
          ...
          {
            type: "text",
            info: "请描述练习智慧心念的情境及您的练习过程:________",
          },
          {
            type: "score",
            info: "请选择数字(1~5)，代表这个练习如何有效地协助您进入智慧心念。",
            options: [
              "1:没有效果",
              "2:介于1-3",
              "3:有一点效果",
      ...
      },
      {
        ...
        problems: [
          ...
          {
            type: "text",
            info: "请描述这个技能是否让您变得头脑更清晰:________",
          },
      ...
      // 痛苦耐受作业
      {
        ...
        problems: [
          ...
          {
            type: "text",
            info: "诱发事件(人、事、时、地):危机状态是如何导致的?________",
          },
          {
            type: "multiple",
            info: "请勾选您尝试使用的技能",
